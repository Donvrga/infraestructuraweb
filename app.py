...
with st.container():
    st.subheader("BIENVENIDOS A LA MATERIA DE INFRAESTRUCTURA WEB")
    st.title("DONDE APRENDERAS TODO PARA LAS PAGINAS WEB")
    st.write(
        "Somos unos estudiantes apasionados con la tecnologia y las paginas web."
    )
